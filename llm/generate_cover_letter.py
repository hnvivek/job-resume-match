...
def generate_cover(model: str, job_description: str, resume_content: str,
                   skills_keywords: KeywordsModel, sys_prompt: str):
    # Initialize ChatGPT using environment variable
    llm = ChatOpenAI(
        model_name=model,  # Use "gpt-3.5-turbo" or "gpt-4"
        temperature=0.2    # Kept same temperature as original
    )
    ...
    # Insert system message using SystemMessage
...
{parsed_output.complimentary_close}
"""
        return cover_letter , parsed_output.cover_letter_name
